//===- Z80Disassembler.c - Disassembler for Zilog Z-80 -------------*- C++ -*-===//
//
...
/* By John Källén <johnkal@gmail.com>, 2015 */
...
void Z80_init(MCRegisterInfo *MRI)
{
...
bool Z80_getInstruction(csh ud, const uint8_t *code, size_t code_len, MCInst *instr,
...
bool Z80_64_k_getInstruction(csh ud, const uint8_t *code, size_t code_len, MCInst *instr,
		uint16_t *size, uint64_t address, void *info)
{
	cs_struct *handle = (cs_struct *)(uintptr_t)ud;
